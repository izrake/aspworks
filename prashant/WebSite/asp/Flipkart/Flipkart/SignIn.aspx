...
<body>
    ...
    <div id="signInContainer">
        ...
        <div class="signInDetails">
            ...
            <asp:RequiredFieldValidator ID="vliUserName" ControlToValidate="txtUserName" runat="server"
                Text="*" ForeColor="Red" ErrorMessage="Enter the username"></asp:RequiredFieldValidator>
            <br />
            ...
            <asp:Button Text="SignIn" runat="server" placeholder="Enter your password" class="signInButton"
                ID="cmdSignIn" OnClick="cmdSignIn_Click" />
